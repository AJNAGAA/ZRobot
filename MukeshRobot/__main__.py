    ...
    if query.data == "mukesh_":
        ...
        InlineKeyboardButton(text="🖥️", callback_data="Main_help"),
                    ...
                    [
                        ...
                        InlineKeyboardButton(
                            text="ᴜᴩᴅᴀᴛᴇs 🍷", url=f"https://t.me/zenupdatess"
                        ),
                    ],
                    [
                        InlineKeyboardButton(
                        ...
                        InlineKeyboardButton(
                            text="ᴄᴏɴᴛᴀᴄᴛ  🍹", url="https://t.me/ZencontBot"
                        ),
                    ],
                    [
                ...
                [
                    [
                        InlineKeyboardButton(
                            ...
                            url="https://t.me/ZennnxBot?startgroup=true"
                            )
                       ]
                ]
                     )
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.send_photo(
                ...
                photo=f"{START_IMG}",
                caption=f"""
✨ㅤज़ेन एक्स बॉट अभी भी जिंदा है
━━━━━━━━━━━━━
**जय श्री राम 🚩**
**ᴘʏᴛʜᴏɴ ᴠᴇʀsɪᴏɴ:** `{y()}`
